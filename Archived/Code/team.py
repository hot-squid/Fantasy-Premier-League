...
folder_path_attack = r'C:\Users\thoma\Code\Projects\Fantasy-Premier-League\Data\Team\Accumulated\Attacking'
folder_path_defensive = r'C:\Users\thoma\Code\Projects\Fantasy-Premier-League\Data\Team\Accumulated\Defensive'

# All folders
folders = [folder_path_attack, folder_path_defensive]
...
for folder in folders:
    ...
    if 'Attacking' in folder:
        for i in range(1, len(gameweek_dfs)):
            ...
            GW.to_csv(f"C:\\Users\\thoma\\Code\\Projects\\Fantasy-Premier-League\\Data\\Team\\Seperate_GW\\Attacking\\GW_{i + 7}.csv",
            index=False)
        ...
        for i in range(1, len(gameweek_dfs)):
            GW = decumulate(gameweek_dfs[i-1], gameweek_dfs[i])
            # Proper f-string formatting for the filename
            GW.to_csv(f"C:\\Users\\thoma\\Code\\Projects\\Fantasy-Premier-League\\Data\\Team\\Seperate_GW\\Defensive\\GW_{i + 7}.csv",
            index=False)